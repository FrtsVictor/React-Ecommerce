...
import {
  CartProducts, Container, CartFinalizar, Total,
} from './styles';
            ...
            <CartProducts>
              {itens.map((pdt, index) => (
                <div className="box-product" key={index}>
                  ...
                  <div className="trash">
                    <i className="far fa-trash-alt fa-border fa-md" onClick={() => removeFromCart(pdt)} />
                  </div>
      ...
      <CartFinalizar>
        <div id="container-btn">
          <div className="btn-finalizar">
            <button type="button" onClick={() => finallyCart()}>
              {' '}
